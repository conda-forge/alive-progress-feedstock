...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/alive-progress-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9155&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/alive-progress-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `alive-progress` can be installed with:

```
conda install alive-progress
```

It is possible to list all of the versions of `alive-progress` available on your platform with:
